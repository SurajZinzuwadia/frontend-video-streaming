...
export default function BlogPostCard({ user, index, btnFor, videosrc }) {
  ...
  const handleSubscribe = async () => {
    try {
      ...
      const response = await axios.post(`${apiBaseUrl}/api/users/subscriptions/${loggedUser._id}`, {
          ...
          <>
            ...
            >
              ...
              <StyledInfo>
                ...
                <Button
                  onClick={
                    btnFor === 'h' ? handleHightStreaming : btnFor === 'v' ? handleGroupStreaming : handleStartStreaming
                  }
                  variant="contained"
                  color="primary"
                >
